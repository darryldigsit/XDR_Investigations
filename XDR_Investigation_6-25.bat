:: The following script will trigger events from the following research:
...
:: removes the test directory and contained files
...
:: uncomment above to run:  Attempts to wipe the local security event log
Pause
Exit